...
def _evaluate_code_quality(config, evidence, semantic_score):
    """Require both deterministic checks and the promised semantic review."""
    policy = {**config, "deterministic_required": True, "semantic_required": True}
    return observation(policy, evidence, semantic_score)
...
def default_registry() -> SkillRegistry:
    ...
    definitions = [
        ...
        ("code_quality", "observation", "Inspect maintainability and correctness risks", _evaluate_code_quality),
